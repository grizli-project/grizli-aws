...
roots=`aws s3 ls s3://grizli-grism/Pipeline/Fields/ | grep footprint.fits | awk '{print $4}' | sed "s/_footprint.fits//"`

# Existing
aws s3 ls s3://grizli-grism/Pipeline/Log/Start/ > /tmp/grizli_started.log
aws s3 ls s3://grizli-grism/Pipeline/Log/Finished/ > /tmp/grizli_finished.log
...
for root in $roots; do
    ...
    start=`aws s3 ls s3://grizli-grism/Pipeline/Log/Start/${root}.log | awk '{print $4}'`
    stop=`aws s3 ls s3://grizli-grism/Pipeline/Log/Finished/${root}.log| awk '{print $4}'`
